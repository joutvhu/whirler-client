...
function preventOverrideClass(sighClass, sighObj, except) {
    if (sighObj != null && sighObj['__proto__'] instanceof sighClass) {
        ...
        if (error)
            throw new OtherErrors_1.OverridingError(ErrorMessages_1.default.OVERRIDE_CLASS.replace('[ClassName]', sighClass['name']));
    }
}
    ...
    while (obj instanceof sighClass) {
        for (var _i = 0, functions_1 = functions; _i < functions_1.length; _i++) {
            ...
            if (typeof i === 'string' && obj.hasOwnProperty(i))
                throw new OtherErrors_1.OverridingError(ErrorMessages_1.default.OVERRIDE_FUNCTION.replace('[FunctionName]', i)
