                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.__config.namespace)
                            body.nsp = this.__config.namespace;
                        return [4 /*yield*/, fetcher_1.default(this.__config.url || '', header, body)];
...
var WhirlerBundle = /** @class */ (function (_super) {
    ...
    function WhirlerBundle(config) {
        var _this = _super.call(this, config) || this;
        _this.__packages = {};
        return _this;
    }
    WhirlerBundle.prototype.config = function (_config) {
        this.__config = __assign({}, this.__config, _config);
    };
