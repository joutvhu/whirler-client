        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, whatwg_fetch_1.fetch(url, {
                            method: 'POST',
                            headers: headers,
                ...
                case 2:
                    result = _a.sent();
                    if (result == null)
                        throw new WhirlerError_1.default(ErrorMessages_1.default.NO_RESPONSE);
                    if (result.error === undefined && typeof result.data !== undefined) {
                        ...
                        if (result.error != null) {
                            ...
                            if (error.message == null)
                                error = {
                                    code: 1,
                                    message: ErrorMessages_1.default.UNKNOWN
                                };
                            throw new WhirlerError_1.default(error);
                        }
                        throw new WhirlerError_1.default(ErrorMessages_1.default.INCORRECT_RESPONSE);
                    }
                    return [3 /*break*/, 4];
